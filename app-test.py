        ...
        if mols:
            ...
            with st.expander("📊 Summary Dashboard", expanded=False):
                ...
                _db_html = (
                    ...
                    ".panel{border:1px solid #e0e0e0;border-radius:8px;"
                    "overflow:hidden;background:#fff;}"
                    ".panel-lbl{font-size:18px;font-weight:800;color:#111;"
                    "padding:8px 12px 4px 12px;background:#fff;display:block;"
                    "font-style:italic;}"
                    ".p3d{height:560px;}"
                    ...
                    "<div class='grid'>"
                    "<div class='panel'>"
                    "<span class='panel-lbl'>(a) Binding Pocket</span>"
                    "<div class='p3d'>" + _da_html + "</div>"
                    "</div>"
                    "<div class='panel'>"
