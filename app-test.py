        ...
        if mols:
            ...
            with st.expander("📊 Summary Dashboard", expanded=False):
                ...
                _db_html = (
                    ...
                    "overflow:hidden;background:#fff;position:relative;height:480px;}"
                    ...
                    ".lbl{position:absolute;bottom:6px;left:7px;font-size:14px;"
                    ...
                    ".row{margin-top:10px;}"
                    ".btn{width:100%;padding:12px 0;border:none;border-radius:7px;"
